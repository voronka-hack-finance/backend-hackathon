...
EXPECTED_PUBLIC_PATHS = {
    ...
    "/api/v1/analytics/regular-expenses/{regular_expense_id}",
...
def test_new_public_groups_have_specific_response_models_and_descriptions():
    ...
    expected_models = {
        ...
        ("/api/v1/notifications/devices", "get"): "NotificationDevicesPageResponse",
        ...
        ("/api/v1/analytics/regular-expenses", "get"): "RegularExpensesPageResponse",
        ("/api/v1/analytics/regular-expenses", "post"): "RegularExpenseResponse",
        ("/api/v1/analytics/regular-expenses/{regular_expense_id}", "get"): "RegularExpenseResponse",
        ("/api/v1/analytics/regular-expenses/{regular_expense_id}", "patch"): "RegularExpenseResponse",
        ("/api/v1/analytics/regular-expenses/{regular_expense_id}", "delete"): "StatusResponse",
        ("/api/v1/debts", "get"): "DebtsPageResponse",
        ("/api/v1/debts", "post"): "DebtResponse",
        ("/api/v1/debts/{debt_id}", "get"): "DebtResponse",
        ("/api/v1/debts/{debt_id}", "patch"): "DebtResponse",
        ("/api/v1/debts/{debt_id}", "delete"): "StatusResponse",
        ("/api/v1/health/profile", "get"): "FinancialHealthProfileResponse",
        ("/api/v1/health/score", "get"): "FinancialHealthScoreResponse",
        ("/api/v1/health/history", "get"): "FinancialHealthHistoryPageResponse",
...
def test_mutation_endpoints_have_specific_request_models():
    ...
    expected_models = {
        ...
        ("/api/v1/analytics/regular-expenses", "post"): "RegularExpenseCreateRequest",
        ("/api/v1/analytics/regular-expenses/{regular_expense_id}", "patch"): "RegularExpenseUpdateRequest",
        ("/api/v1/debts", "post"): "DebtCreateRequest",
        ("/api/v1/debts/{debt_id}", "patch"): "DebtUpdateRequest",
