...
Scope: remaining gaps after cleanup pass (README visuals and Firebase excluded by policy)
...
| Firebase production push | Configure `FIREBASE_*` env when needed — out of scope |
