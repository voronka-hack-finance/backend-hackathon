...
from common.messaging import MessageError, MessageWorker, check_rabbitmq, require_user
...
from services.finance_service.app.db import SessionLocal, engine
...
def handle_transactions_bulk_create(payload: dict, envelope: dict) -> dict:
    ...
    with SessionLocal() as db:
        ...
        stmt = stmt.on_conflict_do_nothing(constraint="uq_transactions_user_dedupe_key")
